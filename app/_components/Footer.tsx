...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-zinc-100 py-28 px-4 md:px-0">
      <div className="container mx-auto pb-12 flex flex-col gap-4">
        <p className="text-zinc-500">Let&apos;s get in touch</p>
        <h2 className="text-3xl md:text-6xl">okicramo9@gmail.com</h2>
      </div>
      <div className="border-t border-zinc-300 container mx-auto pt-12 flex items-center justify-between">
